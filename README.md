...
- **Backend** – FastAPI server that predicts peak noise levels using the ML model.
- **Dashboard** – Streamlit interface that visualizes noise levels, energy generation, and city noise maps.
- **Hardware** – Piezoelectric sensor system that converts urban noise vibrations into electrical energy.
